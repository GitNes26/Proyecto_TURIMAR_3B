                ...
                <div class="col">
                  <table class="table table-hover">
                    <thead class="thead-dark text-center">
                      <tr>
                        <th colspan="2">PAISES REGISTRADOS</th>
                      </tr>                      
                    </thead>
                    <tbody>
                      <?php
                          $consulta_paises="SELECT * FROM PAISES ORDER BY PAIS";
                          $resultado_paises=$turi->seleccionar($consulta_paises);
                          foreach ($resultado_paises as $fila) {
                            echo "<tr><td>$fila->PAIS</td>
                                  <td>
                                    <div class='btn-group btn-block' role='group'>
                                      <button type='button' class='btn btn-info btn-editar' data-toggle='modal' data-target='#editar-pais' data-id='".$fila->ID."' data-pais='".$fila->PAIS."'><i class='fas fa-pencil-alt'></i></button>";
                                      if($sesionROL>2){ echo"
                                      <button type='button' class='btn btn-danger btn-eliminar' data-toggle='modal' data-target='#eliminar-pais' data-id='".$fila->ID."'><i class='far fa-trash-alt'></i></button>";} echo"
                                    </div>
                                  </td></tr>";
                          }
                      ?>            
