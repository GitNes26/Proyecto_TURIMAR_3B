...
<html lang="es">
  <head>
      ...
      <style></style>
      <title>Aerolineas - Turimar</title>
  </head>
        ...
        <div class="modal fade" id="BtnConstruccion" tabindex="-1" role="dialog" aria-labelledby="BtnConstruccionLabel"
          ...
          <div class="row jumbotron jumbotron-fluid d-flex justify-content-center"
              ...
              <div class=" w-50 text-dark">
                  <h1 class="display-1 text-center font-weight-bold text-dark">AEROLINEAS</h1>
              </div>
          </div>
          ...
          <div class="container bg-light mt-5">
            ...
            <form action="registroAerolinea.php" method="POST" class="mt-3">
              <h2 class="text-dark pt-5">REGISTRO AEROLINEA</h2>
              <div class="form-row">
                <div class="col mt-2">
                  <input type="text" class="form-control form-control-lg" placeholder="Nombre de la aerolinea" name="aerolineaRegistro">
                </div>
              </div>
              <div class="form-row">
                <div class="col mt-4">
              ...
              <div class="col">
                <table class="table table-hover">
                  <thead class="thead-dark text-center">
                    <tr>
                      <th colspan="2">AEROLINEAS REGISTRADOS</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      $SQL_CONSULTA="SELECT * FROM AEROLINEAS ORDER BY AEROLINEA;";
        ...
        <script>
            $( document ).ready(function() {
                ...
                $(".btn-eliminar").click(function() //.btn-eliminar es el nombre de la clase en el boton que manda a llamar el modal
                {
                    ...
                    $("#id_aerolinea").val(id_aerolinea);
                    
                });   

                $('.btn-editar').click(function(){ 
                    id_editar=$(this).data('id'); //id es obtenido del data-id en el boton editar
                    var nombre_aerolinea=$(this).data('aerolinea'); //id es obtenido del data-aerolinea en el boton editar
                    
                    $("#id_aerolinea_editar").val(id_editar);
                    $("#nombre_aerolinea_editar").val(nombre_aerolinea);
