      ...
      <div class="container-fluid text-white">
        ...
        <div class="modal fade" id="BtnConstruccion" tabindex="-1" role="dialog" aria-labelledby="BtnConstruccionLabel"
          ...
          <div class="container bg-light mt-5 text-dark">
            <!--FORM REGISTRO TABLA TOUR-->
            <form action="registroTour.php" method="POST" class="mt-3">
                <div class="form-row">
                    <div class="col-lg-9 col-sm-12 mt-5">
                    </div> <?php
                    if($sesionROL>1){ echo"
                        <div class='col-lg-3 col-sm-12 mt-5'>
                            <button onclick=location.href='FormTours.php' type='button' class='btn btn-primary btn-block'>Regresar a Registro Tour</button>
                        </div>";
                    }?>
                </div>
            </form>

            <!--TABLA TOURS REGISTRADOS-->
            <div class="row mt-5">
              <div class="col">
                <table class="table table-hover">
                  <thead class="thead-dark text-center">
                    <tr>
                      <th colspan="6">TOURS REGISTRADOS</th>
                    </tr>
                    <tr>
                        <td class="font-weight-bold text-left">TOUR</td>
                        <td class="font-weight-bold text-left">DURACION</td>
                        <td class="font-weight-bold text-left">NOCHES</td>
                        <td class="font-weight-bold text-left">CAPACIDAD</td>
                        <td class="font-weight-bold text-left">PRECIO</td>
                        <td class="font-weight-bold text-left"></td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      $SQL_CONSULTA="SELECT * FROM TOURS ORDER BY TOUR;";
                        ...
                        echo "<tr>
                                ...
                                <div class='btn-group btn-block' role='group'>";
                                    switch($sesionROL){
                                        ...
                                        break;
                                        case 2: echo"
                                            <button type='button' class='btn btn-info btn-editar' data-toggle='modal' data-target='#editar-tour' data-id='".$fila->ID."' data-tour='".$fila->TOUR."' data-descripcion='".$fila->DESCRIPCION."' data-duracion='".$fila->DURACION."' data-capacidad='".$fila->CAPACIDAD."' data-precio='".$fila->PRECIO."'><i class='fas fa-pencil-alt'></i></button>";
                                        break;
                                        case 3: echo"
                                            <button type='button' class='btn btn-info btn-editar' data-toggle='modal' data-target='#editar-tour' data-id='".$fila->ID."' data-tour='".$fila->TOUR."' data-descripcion='".$fila->DESCRIPCION."' data-duracion='".$fila->DURACION."' data-capacidad='".$fila->CAPACIDAD."' data-precio='".$fila->PRECIO."'><i class='fas fa-pencil-alt'></i></button>
                                            <button type='button' class='btn btn-danger btn-eliminar' data-toggle='modal' data-target='#eliminar-tour' data-id='".$fila->ID."'><i class='far fa-trash-alt'></i></button>";
                                        break; 
                                    } echo"
                                </div>
                                </td>
          ...
          <!-- ------------------------------------------------------------------------------- -->
                <!-- Modal Eliminar-->
                <div class="modal fade text-dark" id="eliminar-tour" tabindex="-1" aria-labelledby="EliminarModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="EliminarModalLabel">Eliminar Tour</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="eliminarTour.php" method="POST">
                                <div class="modal-body">
                                    <input type="hidden" id="id_tour_e" name="id_tour_eliminar">
                ...
                <!-- Modal Editar-->
                <div class="modal fade text-dark" id="editar-tour" tabindex="-1" aria-labelledby="EditarModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="EditarModalLabel">Editar Tour</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="editarTour.php" method="POST">
                                <div class="modal-body">
                                    <input type="hidden" name="id_tour" id="id_editar">
                                    <div class="form-row">
                                        <div class="col mt-2">
                                            <input type="text" class="form-control form-control-lg" placeholder="Nombre del tour" name="tour" id="nombre_tour_editar">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col mt-2">
                                            <textarea class="form-control form-control-lg" placeholder="Descripción del tour" name="descripcion" rows="3" id="descripcion_tour_editar"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col mt-2">
                                            <input type="text" class="form-control form-control-lg" placeholder="Duración del tour" name="duracion" id="duracion_tours_editar">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col mt-2">
                                            <input type="number" class="form-control form-control-lg" placeholder="Capacidad del tour" name="capacidad" id="capacidad_tour_editar">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col mt-2">
                                            <input type="text" class="form-control form-control-lg" placeholder="Precio del tour" name="precio" id="precio_tour_editar">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
