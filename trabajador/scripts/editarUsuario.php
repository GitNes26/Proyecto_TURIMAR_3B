  ...
  <body class=bg-dark>
    <div class='container text-white'>
      ...
      $sesionROL = $_SESSION["roluser"];
        ...
        SET CORREO='$correo', NOMBRE='$nombre', APELLIDO_PATERNO='$aPaterno', APELLIDO_MATERNO='$aMaterno', CELULAR='$tel', FECHA_NACIMIENTO='$fecha', CALLE='$calle', NO_EXT=$no_ext, COLONIA='$colonia', CIUDAD='$ciudad', PAIS=$pais
