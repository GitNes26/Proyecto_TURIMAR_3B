  ...
  <body class=bg-dark>
    <div class='container mt-5 p-5'>
      ...
      $sesion = $_SESSION["usuario"];
        ...
        WHERE ID=$BtnCancelar";
        $db->ejecutarSQL($SQL2);

        echo "
            <div class='alert alert-success alert-lg display-2 font-weight-bold text-center'> TOUR CANCELADO
              <div class='progress'>
        ...
        if($Pag=='admin'){ header("location: ../Formularios/VerUsuarios.php"); }
