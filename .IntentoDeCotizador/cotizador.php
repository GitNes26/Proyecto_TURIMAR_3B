                    ...
                    <div class='modal-dialog modal-lg'>
                        <div class='modal-content bg-light'>
                            ...
                            <div class='modal-body text-dark'>
                                ...
                                <form class='needs-validation' novalidate action='scripts/calcularCotizacion.php' method='GET'>
...
<script>
        $(document).ready(function(e){
            $("#selectEstado").change(function(){
                var parametros= "IDedo="+$("#selectEstado").val();
                alert(parametros);
                $.ajax({
                    data: parametros,
                    url: 'ajaxCiudades.php',
                    type: 'post',
...
<?php
    ...
    // print_r("hola");
    // $ESTADO=$_POST['ID'];
    // $CIUDAD="SELECT * FROM CIUDADES WHERE ESTADO='$ESTADO'"; 
    // $RESULTADOc=$turi->seleccionar($CIUDAD);  
    
    // print_r($RESULTADOc);
    // while ($a=$RESULTADOc->fetch_assoc()) {
    //     $edo="<option value='".$a->ID."'>".$a->CIUDAD."</option>";
    // }
