...
<body class="bg-secondary">
        ...
        <div class="container text-light">
            ...
            <div class="row">
                <?php              
                    ...
                    // $IDtour="SELECT ID FROM TOURS";
                    // $RESULTADOid=$turi->seleccionar($IDtour); 

                    $PAIS="SELECT * FROM PAISES WHERE PAIS='Mexico'";
                    ...
                    // $AEROLINEAS="SELECT aerolineas.AEROLINEA FROM TOURS INNER JOIN AEROLINEA_TOUR on aerolinea_tour.TOUR=tours.ID INNER JOIN AEROLINEAS on aerolineas.ID=aerolinea_tour.AEROLINEA WHERE tours.ID=";
                                                ...
                                                <div class='col-6 row'>
                                                    ...
                                                    <div class='col-8'>
                                                        <div class='tab-content' id='v-pills-tabContent'>
                                                            ...
                                                            <div class='tab-pane fade' id='v-aereolinea".$i->ID."' role='tabpanel' aria-labelledby='v-aereolinea".$i->ID."-tab'>";
                                                                $SQL1="SELECT aerolineas.AEROLINEA FROM tours INNER JOIN aerolinea_tour on aerolinea_tour.TOUR=tours.ID INNER JOIN aerolineas on 
                                                                aerolineas.ID=aerolinea_tour.AEROLINEA WHERE tours.ID=$A";
                                                                $AEROLINEAS=$SQL1; echo "esto es AEROLINEAS =".$AEROLINEAS."";
                                                                foreach ($AEROLINEAS as $a) {echo "esto es a = ".$a."";}
                                                                echo"
                                                            </div>
                                                            <div class='tab-pane fade' id='v-hotel".$i->ID."' role='tabpanel' aria-labelledby='v-hotel".$i->ID."-tab'>".$i->HOTEL."</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class='col-6 row'>
                                            ...
                                            <div class='form-group mt-3'>
                                                <div class='row'>       
                                                    ...
                                                    <div class='col-4'>
                                                        ...
                                                        <select name='cotizarEstado' class='form-control'>
                                                    ...
                                                    <div class='col-4'>
                                                        <label for='origen' class='col-form-label lead font-weight-bold'>-</label>
                                                        <select name='cotizarCiudad' class='form-control'>
    ...
    <!-- <script type="text/javascript">
        ...
        $('#estados').click(function(){ alert("HOLA")
        $('#estados option:selected').each(function(){
        ESTADO = $(this).val();
        $.post('prueba.php', {ESTADO: ESTADO},
        function(data){
        $('#ciudades').html(data)
        })
        })
