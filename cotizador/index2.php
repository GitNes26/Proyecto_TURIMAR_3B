...
<body class="bg-secondary">
    ...
    <div class="container-fluid text-white">
        ...
        <?php
            ...
            $ESTADOS="Call CotizacionEstados($cotizarEstado1)";
            $RESULTADOe=$turi->seleccionar($ESTADOS);

            $CIUDADES="SELECT * FROM CIUDADES WHERE ESTADO=$cotizarEstado1 ORDER BY CIUDAD";
                                    ...
                                    <div class='form-group mt-3'>
                                        <div class='row'>       
                                            ...
                                            <div class='col-md-4'>                      
                                                ...
                                                <select name='cotizarPais2' class='form-control' id='selectPais' readonly>";
                                            ...
                                            <div class='col-md-4'>
                                                ...
                                                <select name='cotizarEstado2' class='form-control' id='selectEstado' readonly>";
                                            ...
                                            <div class='col-md-4'>
                                                <label for='origen' class='col-form-label lead font-weight-bold'>-</label>
                                                <select name='cotizarCiudad2' class='form-control' id='selectCiudad'>";
