...
<body class="bg-secondary">
    ...
    <div class="container-fluid text-white">
        ...
        <?php
            ...
            $ESTADOS="Call CotizacionEstados($cotizarEstado2)";
            $RESULTADOe=$turi->seleccionar($ESTADOS);

            $CIUDADES="Call CotizacionCiudades($cotizarCiudad2)";
            $RESULTADOc=$turi->seleccionar($CIUDADES);

            $AEROLINEAS="SELECT aerolineas.ID, aerolineas.AEROLINEA FROM AEROLINEAS INNER JOIN AEROLINEA_TOUR ON AEROLINEA_TOUR.AEROLINEA=AEROLINEAS.ID INNER JOIN TOURS ON AEROLINEA_TOUR.TOUR=TOURS.ID WHERE TOURS.ID=$IDtour ORDER BY AEROLINEAS.AEROLINEA";
                                    ...
                                    <div class='form-group'>
                                        <div class='row'>
                                            ...
                                            <div class='col-md-4'>
                                                ...
                                                <select name='cotizarFechaTour' id='fechaTour' class='form-control'>
                                                    <option>Fechas disponibles</option>";
                                                    foreach ($RESULTADO as $i)
                                                    {
                                                        echo "<option value='".$i->FECHA_TOUR."'>".$i->FECHA_TOUR."</option>";
                                                    }echo"
                                                </select>
                                            </div>
                                            <!--Duración-->
                                    ...
                                    <div class='form-group border rounded p-2'>
                                        <div class='row'>
                                            ...
                                            <div class='col-md-3'>
                                                ...
                                                <input type='number' value='0' name='cotizarAdultos' min='0' max='20' class='form-control' id='adultos'>
                                            </div>
                                            <!--Cantidad Menores-->
                                            <div class='col-md-3'>
                                                <label for='duración' class='col-form-label lead font-weight-bold'>Menores</label>
                                                <input type='number' value='0' name='cotizarMenores' min='0' max='20' class='form-control' id='duaración'>
                                            </div>
                                            <div class='col'>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-md-6 text-center'>
                                                ...
                                                <div class='form-check form-check-inline pt-2'>
                                                    ...
                                                    <label class='form-check-label lead' for='tipoAbierto'>Abierto</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
